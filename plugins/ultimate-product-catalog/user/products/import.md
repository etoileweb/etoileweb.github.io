...
When using [Business Profile](http://wordpress.org/plugins/business-profile/) alongside [Ultimate Product Catalog](https://www.etoilewebdesign.com/plugins/five-star-ultimate-product-catalog/), you'll find an additional set of configuration fields for each Location.
...
If you have created a location but it doesn't appear in your Bookings panel, you may need to re-save the location. This is usually because the location was created before Ultimate Product Catalog was active and updated to the appropriate version.
